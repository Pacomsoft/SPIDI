...
import { createRegistroModule, createRegisterRepository } from '@/modules/registro/infrastructure/dependency-injection';
...
const { useCases } = createRegistroModule(httpClient, configuracionRepository);
